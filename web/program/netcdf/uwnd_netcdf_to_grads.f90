...
program main
  ...
  integer,parameter :: zdef=17
  integer,parameter :: tdef=1460

  character(1024) :: fin  = 'uwnd.2007.nc'  ! input filename
  character(1024) :: fout = 'uwnd.2007.grd' ! output filename
  character(1024) :: netcdf_name = 'uwnd'   ! NetCDF variable name
